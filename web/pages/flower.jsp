            ...
            <li class="mt-tabpage-item">
                <c:forEach items="${requestScope.flowerRose}" var="flower">
                    <div class="slide-content">
                        <a href="client/flowerServlet?action=querryFlowerById&id=${flower.id}&url=/pages/store.jsp"><img style="width: 300px; height: 300px; " src="${flower.img_path}/1.jpg"/>
                            <div class="slide-content-text">${flower.flower_name}</div></a></div>
                </c:forEach>
            </li>
            <li class="mt-tabpage-item">
                <c:forEach items="${requestScope.flowerCarnation}" var="flower">
                <div class="slide-content"><a href="client/flowerServlet?action=querryFlowerById&id=${flower.id}&url=/pages/store.jsp">
