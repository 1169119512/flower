...
<div class="container">
    ...
    <section data-aos="fade-up">
        <div class="card">
            <div class="card-img-left">
                <a href="client/flowerServlet?action=querryFlowerById&url=/pages/store.jsp&id=18">
    ...
    <section data-aos="fade-left">
        <div class="card">
            ...
            <div class="card-img-right"><a href="client/flowerServlet?action=querryFlowerById&url=/pages/store.jsp&id=19">
    ...
    <section data-aos="fade-right">
        <div class="card" >
            <div class="card-img-left">
                <a href="client/flowerServlet?action=querryFlowerById&url=/pages/store.jsp&id=13">
    ...
    <section data-aos="slide-left">
        <div class="card" >
            ...
            <div class="card-img-right">
                <a href="client/flowerServlet?action=querryFlowerById&url=/pages/store.jsp&id=14">
    ...
    <section data-aos="slide-right">
        <div class="card" >
            <div class="card-img-left">
            <a href="client/flowerServlet?action=querryFlowerById&url=/pages/store.jsp&id=15">
    ...
    <section data-aos="zoom-in-left">
        <div class="card right">
            ...
            <div class="card-img-right">
                <a href="client/flowerServlet?action=querryFlowerById&url=/pages/store.jsp&id=17">
