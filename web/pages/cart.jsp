...
<%--				<td colspan="5" style="text-align:center"><a href="index.jsp"><b>当前的购物车空空如也！快去和小伙伴浏览商品吧！</b></a></td>--%>
		...
		<div class="cart_info">
			...
			<span class="cart_span_3"><a class="clearCart"  href="cartServlet?action=clear">清空购物车</a></span>
			<span class="cart_span_4"><a href="orderServlet?action=createOrder">去结账</a></span>
		</div>
		</c:if>
	</div>
