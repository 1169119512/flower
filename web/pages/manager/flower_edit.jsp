...
<div id="box-border">
	<div class="pull-left">
		...
		<ul class="bd">
			<li>
				<a href="manager/flowerServlet?action=page"><b></b><i class="fa fa-refresh"></i>查看商品</a>
			</li>
			...
			<li>
				<a href="orderServlet?action=watchOrders&url=/pages/manager/order_manager.jsp"><b></b><i class="fa fa-github-alt"></i>订单处理</a>
			</li>
		</ul>
	</div>
	<div class="pull-right">
		<form action="manager/flowerServlet?action=${empty param.id ? "add":"update"}&id=${requestScope.flower.id}"
			...
			<table width="890px" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC">
				<tr style="background-color: #c9b5b0">
					...
					<td colspan="2" valign="middle" class="input_text">&nbsp;&nbsp;<input style="background-color: #c9b5b0"name="flowers_name" type="text"  size="30" value="${requestScope.flower.flower_name}" align="center"></td>
				</tr>
