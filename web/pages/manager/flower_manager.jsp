        ...
        <div class="pull-right">
            <table class="store_all" width="890px" border="2px solid pink" align="center" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC" style="border-bottom:#F0F0F0">
                ...
                <tr>
                    ...
                    <td align="center"><a href="manager/flowerServlet?action=getFlower&id=${flowers.id}&pageNo=${requestScope.page.pageNo}">修改</a></td>
                    <td align="center"><a class="deleteClass"  href="manager/flowerServlet?action=delete&id=${flowers.id}&pageNo=${requestScope.page.pageNo}">删除</a></td>
                </tr>
                </c:forEach>
                <tr colspan="5">
