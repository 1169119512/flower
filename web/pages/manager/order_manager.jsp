		...
		<table class="store_all" width="890px" border="2px solid pink" align="center" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC" style="border-bottom:#F0F0F0">
			...
			<c:forEach items="${sessionScope.orders}" var="order">
				<tr>
					...
					<td align="center" style="background-color:#deddc9"><a href="orderServlet?action=watchOrdersDetailByOrderId&orderId=${order.order_id}">查看详情</a></td>
					<td align="center" style="background-color:#deddc9"><a href="orderServlet?action=delivery&id=${order.order_id}">点击发货</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
